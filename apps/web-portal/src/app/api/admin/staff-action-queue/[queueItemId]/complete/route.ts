/**
 * POST /api/admin/staff-action-queue/[queueItemId]/complete
 * Mark unified queue item as completed. Body: { agencyId?, note? }
 */
...
export async function POST(
  ...
  let body: { agencyId?: string; note?: string };
  try {
